...
import br.com.zup.proposta.Proposta.EnumProspota.StatusAvaliacaoResposta;
...
public class ResultadoAnaliseProposta {
	...
	public ResultadoAnaliseProposta(String documento, String nome, StatusAvaliacaoResposta resultadoSolicitacao,
			String idProposta) {
